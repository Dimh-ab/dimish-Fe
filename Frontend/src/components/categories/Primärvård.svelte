<script>
	...
	// $: console.log('vård', element)
    // $: console.log('vård', intersecting)
	...
	$: console.log('checkpoint', intersecting ? $checkPoint = $checkPoint = 4 : '')
...
<style>
    ...
    *{
	...
	.cover, .back-cover{
		height: 180px;
		width: 140px;
		background-color: var( --book-color-primarycare);
