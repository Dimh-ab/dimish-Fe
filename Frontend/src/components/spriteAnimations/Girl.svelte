...
<div
    in:fade
    out:fade
    class={"glitter-smoke " + (transformAvatar ? "visible" : "")}
/>
/>
...
<style>
    .glitter-smoke {
        ...
        /* display: none; */
        box-shadow: 0 0 50px 50px #6f2dff, /* inner  */ 0 0 80px 80px #4c00ff9f,
            /* middle  */ 0 0 100px 100px #8800ff90; /* outer */
        scale: 0;
        transition: all 1s;
    ...
    @keyframes glow {
        from {
            box-shadow: 0 0 10px 5px #6f2dff94,
                /* inner  */ 0 0 30px 15px #4c00ff6d,
                /* middle  */ 0 0 50px 25px #8800ff6f; /* outer */
        }
        to {
            box-shadow: 0 0 40px 20px #6f2dff94,
                /* inner  */ 0 0 60px 30px #4c00ff6d,
                /* middle  */ 0 0 110px 60px #8800ff6f; /* outer  */
        }
    }
